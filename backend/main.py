...
from routers import vendors,products , quotations, orders, stock_history, purchases, payments, productions, shipments, purchase_orders, remittances, product-parts
...
app.include_router(product_parts.router)
